...
// Sample articles data for archive
const archiveArticles = [
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem1 },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem2 },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem3 },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem1 },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem2 },
  { title: "Listening to Films That Drift", category: "Film", date: "Aug 12", image: imgArticlesItem3 },
      ...
      <div className="flex flex-col items-center justify-center px-6 py-12 sm:py-16 lg:py-24 w-full">
        <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8 items-center max-w-[640px] w-full">
          ...
          <p className="font-semibold leading-[1.4] text-[#0f0e0e] text-sm sm:text-base lg:text-lg text-center">
            No matter— just make sure it's clear, fast, and refined
          </p>
    ...
    <footer className="relative shrink-0 w-full bg-[#0f0e0e] rounded-t-lg">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-6 sm:gap-8 px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-16 w-full">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <p className="font-semibold leading-[1.4] text-[#8c8d92] text-xs sm:text-sm lg:text-base max-w-xs">
            Collecting visual moments and atmospheric experiences
          </p>
        </div>
        <div className="flex flex-wrap gap-6 sm:gap-8 lg:gap-12">
          <div className="flex flex-col gap-2 sm:gap-3">
            ...
            <ul className="flex flex-col gap-1.5 sm:gap-2">
              <li><a href="#" className="font-semibold text-[#8c8d92] text-xs sm:text-sm lg:text-base hover:text-[#f6f8fb] transition-colors">Films</a></li>
              <li><a href="#" className="font-semibold text-[#8c8d92] text-xs sm:text-sm lg:text-base hover:text-[#f6f8fb] transition-colors">Music</a></li>
              <li><a href="#" className="font-semibold text-[#8c8d92] text-xs sm:text-sm lg:text-base hover:text-[#f6f8fb] transition-colors">Visuals</a></li>
            </ul>
          </div>
          <div className="flex flex-col gap-2 sm:gap-3">
            <h4 className="font-semibold text-[#f6f8fb] text-xs sm:text-sm lg:text-base">
      ...
      <div className="border-t border-[#2f2e2e] px-4 sm:px-6 lg:px-12 py-4 sm:py-6">
        <p className="font-semibold text-[#8c8d92] text-xs sm:text-sm text-center">
          © 2024 Grain Archive. Moments, preserved and shared.
        </p>
      </div>
    </footer>
  );
