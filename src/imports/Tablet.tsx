import svgPaths from "./svg-dxkbn4btzq";
    ...
    <div className="relative shrink-0 w-full" data-name="Logo container">
      <div className="content-stretch flex flex-col items-start pb-[20px] px-[20px] relative w-full">
        <div aria-hidden="true" className="aspect-[1218.568603515625/172.13067626953125] relative shrink-0 w-full" data-name="Grain Archive Logo" role="presentation">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 740 104.53">
...
function ButtonLarge() {
  return (
    <button aria-label="View all articles" className="bg-size-[1280px_600px,auto_auto] bg-top-left cursor-pointer min-w-[600px] relative rounded-[8px] shrink-0 w-full" data-name="Button - large" style={{ backgroundImage: `url('${imgButtonLarge}'), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)` }}>
      <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center min-w-[inherit] p-[24px] relative w-full">
...
function FeaturedAlbumSection() {
  return (
    <section className="relative rounded-[8px] shrink-0 w-full" data-name="Featured album section">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center pb-[60px] pt-[264px] px-[10px] relative w-full">
          <h2 className="absolute block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] left-[10px] max-w-[760px] text-[#f6f8fb] text-[160px] top-[60px] tracking-[-8px] w-[760px] whitespace-pre-wrap" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            Featured Album
          </h2>
          <AlbumDisplay />
        </div>
  ...
  return (
    <section className="bg-size-[1280px_600px,auto_auto] bg-top-left relative rounded-[8px] shrink-0 w-full" data-name="Cinema selects section" style={{ backgroundImage: `url('${imgCinemaSelectsSection}'), linear-gradient(90deg, rgb(245, 245, 245) 0%, rgb(245, 245, 245) 100%)` }}>
      <div className="content-stretch flex flex-col gap-[80px] items-start px-[10px] py-[60px] relative w-full">
        <h2 className="block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] max-w-[760px] relative shrink-0 text-[#0f0e0e] text-[160px] tracking-[-8px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
          Cinema Selects
        </h2>
        <Content4 />
      </div>
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Logo container">
      <div className="aspect-[760/130.201171875] relative shrink-0 w-full" data-name="Grain Archive Logo">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 760 130.201">
          <path d={svgPaths.p114d3a00} fill="var(--fill-0, #F6F8FB)" id="Grain Archive Logo" />
        </svg>
      </div>
    </div>
  );
...
export default function Tablet() {
  return (
    <div className="bg-size-[1280px_600px,auto_auto] bg-top-left content-stretch flex flex-col isolate items-center relative size-full" data-name="Tablet" style={{ backgroundImage: `url('${imgButtonSmall}'), linear-gradient(90deg, rgb(15, 14, 14) 0%, rgb(15, 14, 14) 100%)` }}>
      <div className="absolute h-[5186.201171875px] inset-[60px_20px_0_20px] pointer-events-none">
        <Navigation />
      </div>
      <Marquee />
