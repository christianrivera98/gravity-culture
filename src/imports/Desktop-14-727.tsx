...
function ArticlesList() {
  return (
    <main className="content-start flex flex-wrap gap-[10px] h-[2830px] items-start justify-center relative shrink-0 w-full" data-name="Articles list" tabIndex="-1">
      <ArticlesItem />
      <ArticlesItem1 />
      <ArticlesItem2 />
      <ArticlesItem3 />
...
function Marquee() {
  return (
    <div className="content-stretch flex items-center justify-center py-[120px] relative shrink-0 w-full z-[3]" data-name="Marquee">
...
export default function Desktop() {
  return (
    <div className="bg-size-[1280px_600px,auto_auto] bg-top-left content-stretch flex flex-col isolate items-center relative size-full" data-name="Desktop" style={{ backgroundImage: `url('${imgButtonSmall}'), linear-gradient(90deg, rgb(15, 14, 14) 0%, rgb(15, 14, 14) 100%)` }}>
      <div className="absolute h-[4844px] inset-[0_20px] pointer-events-none">
        <Navigation />
      </div>
