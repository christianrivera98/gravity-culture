...
function ContactParagraph() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[400px] relative shrink-0 text-[#f6f8fb] w-full whitespace-pre-wrap" data-name="Contact paragraph">
      ...
      <div className="flex flex-col font-['Geist:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[20px] tracking-[-0.4px] w-full" style={{ fontFeatureSettings: "'ss01', 'ss03'" }}>
        ...
        <p>
          ...
          <a className="cursor-pointer decoration-solid leading-[1.4] underline" href="mailto:mail@grainarchive.com">
            <span className="decoration-solid leading-[1.4]" href="mailto:mail@grainarchive.com">
    ...
    <section className="max-w-[1800px] relative shrink-0 w-full" data-name="Contact section">
      <div className="flex flex-row justify-center max-w-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start justify-center max-w-[inherit] pb-[120px] px-[10px] relative w-full">
          <div className="flex-[1_0_0] h-[700px] min-h-px min-w-px relative rounded-[8px]" data-name="Image">
    ...
    <footer className="relative shrink-0 w-full z-[1]" data-name="Footer">
      <div className="flex flex-row items-end justify-center size-full">
        <div className="content-stretch flex gap-[40px] items-end justify-center pb-[20px] pt-[120px] px-[20px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Tilt_Warp:Regular',sans-serif] justify-end leading-[0.85] min-h-px min-w-px relative text-[#f6f8fb] text-[200px] tracking-[-8px] whitespace-pre-wrap" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            <h2 className="block mb-0">Grain</h2>
...
export default function Desktop() {
  return (
    <div className="bg-size-[1280px_600px,auto_auto] bg-top-left content-stretch flex flex-col isolate items-center relative size-full" data-name="Desktop" style={{ backgroundImage: `url('${imgButtonSmall}'), linear-gradient(90deg, rgb(15, 14, 14) 0%, rgb(15, 14, 14) 100%)` }}>
      <div className="absolute h-[3154px] inset-[0_20px] pointer-events-none">
        <Navigation />
      </div>
      <HeaderSection />
      <BodyContent />
