import svgPaths from "./svg-nidr9azf1l";
...
function HeaderSection() {
  return (
    <header className="content-stretch flex flex-col items-center py-[140px] relative rounded-[8px] shrink-0 w-full" data-name="Header section">
...
function ArticlesList() {
  return (
    <main className="content-stretch flex flex-col gap-[10px] h-[3750px] items-center relative shrink-0 w-full" data-name="Articles list" tabIndex="-1">
      <ArticlesItem />
      <ArticlesItem1 />
      <ArticlesItem2 />
      <ArticlesItem3 />
...
function Marquee() {
  return (
    <div className="content-stretch flex items-center justify-center py-[64px] relative shrink-0 w-full z-[3]" data-name="Marquee">
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Logo container">
      <div className="aspect-[1218.568603515625/172.13067626953125] relative shrink-0 w-full" data-name="Grain Archive Logo">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 335 47.3213">
          <path d={svgPaths.pf86e500} fill="var(--fill-0, #F6F8FB)" id="Grain Archive Logo" />
        </svg>
      </div>
    </div>
  );
...
export default function Mobile() {
  return (
    <div className="bg-size-[1280px_600px,auto_auto] bg-top-left content-stretch flex flex-col isolate items-center relative size-full" data-name="Mobile" style={{ backgroundImage: `url('${imgButtonSmall}'), linear-gradient(90deg, rgb(15, 14, 14) 0%, rgb(15, 14, 14) 100%)` }}>
      <div className="absolute h-[5364.3212890625px] inset-[0_20px] pointer-events-none">
        <Navigation />
      </div>
