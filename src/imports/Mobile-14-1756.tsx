import svgPaths from "./svg-opkybq8w9s";
...
function HeaderSection1() {
  return (
    <div className="content-stretch flex flex-col items-center pb-[64px] pt-[140px] relative rounded-[8px] shrink-0 w-full" data-name="Header section">
...
function ObjectsMarquee() {
  return (
    <section aria-hidden="true" aria-label="A scrolling row of vintage media objects, including a Polaroid photo, a green vinyl record, a VHS tape, a telegram slip, an audio cassette, a postcard, and a floppy disk." className="content-stretch flex gap-[18px] items-center justify-center overflow-clip pr-[36px] py-[20px] relative shrink-0" data-name="Objects marquee">
      <div aria-hidden="true" className="h-[135px] relative shrink-0 w-[112px]" data-name="Polaroid" role="presentation">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[112.83%] left-[-4.85%] max-w-none top-[-7.19%] w-[108.84%]" src={imgPolaroid} />
        </div>
      </div>
      <div aria-hidden="true" className="h-[175px] relative shrink-0 w-[96px]" data-name="Paper scrap" role="presentation">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPaperScrap} />
      </div>
      <div aria-hidden="true" className="relative shrink-0 size-[160px]" data-name="Vinyl record" role="presentation">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[109.93%] left-[-5.06%] max-w-none top-[-5.33%] w-[110.12%]" src={imgVinylRecord} />
        </div>
      </div>
      <div aria-hidden="true" className="h-[90px] relative shrink-0 w-[157px]" data-name="VHS tape" role="presentation">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[173.06%] left-[-22.94%] max-w-none top-[-37.55%] w-[149.65%]" src={imgVhsTape} />
        </div>
      </div>
      <div aria-hidden="true" className="h-[120px] relative shrink-0 w-[174px]" data-name="Telegram" role="presentation">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[125.43%] left-[-6.85%] max-w-none top-[-12.71%] w-[113.7%]" src={imgTelegram} />
        </div>
      </div>
      <div aria-hidden="true" className="h-[80px] relative shrink-0 w-[128px]" data-name="Casette" role="presentation">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[192.77%] left-[-36.44%] max-w-none top-[-54.47%] w-[181.71%]" src={imgCasette} />
        </div>
      </div>
      <div className="flex h-[154.491px] items-center justify-center relative shrink-0 w-[221.873px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-4 flex-none">
          <div aria-hidden="true" className="h-[140px] relative w-[212.625px]" data-name="Postcard" role="presentation">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="flex h-[120.524px] items-center justify-center relative shrink-0 w-[117.363px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="flex-none rotate-6">
          <div aria-hidden="true" className="h-[110px] relative w-[106.448px]" data-name="Floppy disk" role="presentation">
  ...
  return (
    <main className="max-w-[1280px] relative shrink-0 w-full" data-name="About section" tabIndex="-1">
      <div className="flex flex-col justify-center max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col font-['Geist:SemiBold',sans-serif] font-semibold gap-[40px] items-start justify-center leading-[1.4] max-w-[inherit] px-[50px] py-[64px] relative text-[#f6f8fb] text-[20px] tracking-[-0.4px] w-full whitespace-pre-wrap">
          <h2 className="block relative shrink-0 w-full" style={{ fontFeatureSettings: "'ss01', 'ss03'" }}>
            Why this exists
          </h2>
          <p className="relative shrink-0 w-full" style={{ fontFeatureSettings: "'ss01', 'ss03'" }}>
...
function ContactParagraph() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start max-w-[400px] min-h-px min-w-px relative text-[#f6f8fb] whitespace-pre-wrap" data-name="Contact paragraph">
...
function ContactSection() {
  return (
    <section className="max-w-[1800px] relative shrink-0 w-full" data-name="Contact section">
      <div className="flex flex-col justify-center max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-start justify-center max-w-[inherit] pb-[80px] px-[10px] relative w-full">
          <div className="h-[440px] relative rounded-[8px] shrink-0 w-full" data-name="Image">
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Logo container">
      <div className="aspect-[1218.568603515625/172.13067626953125] relative shrink-0 w-full" data-name="Grain Archive Logo">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 335 47.3213">
          <path d={svgPaths.p2825bf80} fill="var(--fill-0, #F6F8FB)" id="Grain Archive Logo" />
        </svg>
      </div>
    </div>
  );
...
export default function Mobile() {
  return (
    <div className="bg-size-[1280px_600px,auto_auto] bg-top-left content-stretch flex flex-col isolate items-center relative size-full" data-name="Mobile" style={{ backgroundImage: `url('${imgButtonSmall}'), linear-gradient(90deg, rgb(15, 14, 14) 0%, rgb(15, 14, 14) 100%)` }}>
      <div className="absolute h-[2935.3212890625px] inset-[0_20px] pointer-events-none">
        <Navigation />
      </div>
      <HeaderSection />
      <BodyContent />
